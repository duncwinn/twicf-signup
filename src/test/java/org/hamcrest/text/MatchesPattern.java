...
/**
 * Backported from https://github.com/hamcrest/JavaHamcrest/commit/6b5489e18dc7865b68b164de60b1505f981349b0
 */
public class MatchesPattern extends TypeSafeMatcher<String> {
	...
	/**
	 * Creates a matcher of {@link String} that matches when the examined string
	 * exactly matches the given regular expression, treated as a
	 * {@link Pattern}.
	 */
	@Factory
